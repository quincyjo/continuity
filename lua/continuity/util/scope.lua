---@class Scope
---@field subscribe            fun(self, source: Subscribable, cb: fun(...))
---@field weak_subscribe       fun(self, source: Subscribable, cb: fun(...))
---@field on_removed           fun(self, source: Removable, cb: fun(id: string))
---@field weak_on_removed      fun(self, source: Removable, cb: fun(id: string))
---@field on_control           fun(self, source: Controllable, cb: fun(...))
---@field weak_on_control      fun(self, source: Controllable, cb: fun(...))
---@field on_added             fun(self, source: Observable, cb: fun(item))
---@field weak_on_added        fun(self, source: Observable, cb: fun(item))
---@field on_updated           fun(self, source: Observable, cb: fun(item))
---@field weak_on_updated      fun(self, source: Observable, cb: fun(item))
---@field on_removed           fun(self, source: Observable, cb: fun(id: string))
---@field weak_on_removed      fun(self, source: Observable, cb: fun(id: string))
